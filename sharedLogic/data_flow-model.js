class DataFlowModel {
  ...
  _validateJsonAndBuildDataSets(json) {
    ...
    return {
      modules: modules,
      dataPaths: dataPaths,
      nodeToModuleAssignments: nodeToModuleAssignments
    };
  }
  ...
  ***************************************************************** */
  ...
  checkModuleWithIdIsReached(moduleId) {
    ...
    return module_notReachedBecauseOfDataPath(module)
      .length === 0;
  }
  ...
  ***************************************************************** */
  ...
  checkDataPathWithIdIsReached(dataPathId) {
    ...
    return dataPath_notReachedBecauseOfDataPath(dataPath)
      .length === 0;
  }
  ...
  checkDataPathWithIdIsNotPossibleDataPath(dataPathId) {
    ...
    if (dataPath_notReachedBecauseOfDataPath(dataPath)
      .contains(dataPathId)) {
      return true;
    }
    return false;
